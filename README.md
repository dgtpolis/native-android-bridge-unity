...
## AndroidManifest.xml
You have to add provider tag in AndroidManifest.xml and replace {YOUR_FILE_PROVIDER_NAME} with your file provider name. Provider tag must have under application tag.
```
<provider
